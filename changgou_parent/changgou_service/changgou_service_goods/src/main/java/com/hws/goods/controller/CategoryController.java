...
import com.hws.goods.service.CategoryService;
...
public class CategoryController {
     ...
     * 根据父Id查询数据
     */
    @ApiOperation(value = "根据父Id查询数据",notes = "根据父Id查询数据",tags = {"CategoryController"})
    @GetMapping("/findByParentId/{id}")
    public Result<List<Category>> findByParentId(@PathVariable(value = "id") Integer id){
        List<Category> categoryList = categoryService.findByPrantId(id);
