...
import com.hws.goods.service.SpecService;
...
public class SpecController {
     ...
     * 根据分类id查询所有的规格
     */
    @ApiOperation(value = "根据分类id查询所有的规格",notes = "根据分类id查询所有的规格",tags = {"SpecController"})
    @PostMapping("/findByCategory/{id}")
    public Result<List<Spec>> findByCategoryId(Integer id){
